...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2020 at 02:30 PM
...
--
-- Database: `provincias_dominicana`
--

-- --------------------------------------------------------

--
-- Table structure for table `distritos_municipales`
--
...
--
-- Dumping data for table `distritos_municipales`
--

INSERT INTO `distritos_municipales` (`distrito_id`, `nombre`, `municipio_id`) VALUES
(1, 'Barreras', 2),
(2, 'Barro Arriba', 2),
(3, 'Clavellina', 2),
...
--
-- Constraints for table `distritos_municipales`
--
ALTER TABLE `distritos_municipales`
  ADD CONSTRAINT `municipio_id` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`municipio_id`);
